# Generated by Django 3.2.25 on 2025-01-05 14:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('girl', 'Boy'), ('boy', 'Girl')], default='Girl', max_length=200, null=True, verbose_name='Gender * ')),
                ('picture', models.ImageField(blank=True, null=True, upload_to='studentImages/', verbose_name="Student's picture")),
                ...
                ('city_name', models.CharField(blank=True, default='Nairobi', max_length=200, null=True, verbose_name='City Name ')),
                ('previous_school', models.CharField(blank=True, max_length=300, null=True, verbose_name='Previous School ')),
                ('transport', models.CharField(choices=[('yes', 'YES'), ('no', 'NO')], default='No', max_length=200, null=True, verbose_name='Transport * ')),
                ('optional_services_required_for_your_child', ckeditor.fields.RichTextField(blank=True, null=True)),
                ...
                ('mother_phone', models.CharField(blank=True, max_length=30, null=True, verbose_name="Mother's Phone Number")),
                ('father_name', models.CharField(blank=True, max_length=200, null=True, verbose_name="Father's Name")),
                ('father_phone', models.CharField(blank=True, max_length=30, null=True, verbose_name="Father's Phone Number")),
                ('guardian_name', models.CharField(blank=True, max_length=200, null=True, verbose_name="Guardian's Name")),
                ('guardian_phone', models.CharField(blank=True, max_length=30, null=True, verbose_name="Guardian's Phone Number")),
                ('date_added', models.DateTimeField(auto_now_add=True, null=True)),
                ('date_updated', models.DateTimeField(auto_now_add=True, null=True)),
                ('term', models.CharField(blank=True, choices=[('Term 1', 'Term 1'), ('Term 2', 'Term 2'), ('Term 3', 'Term 3')], default='Term 1', max_length=200, null=True, verbose_name='Term * ')),
                ('payment', models.IntegerField(blank=True, default=0, verbose_name='Payment in Ksh')),
                ('payment_method', models.CharField(blank=True, choices=[('MPESA', 'MPESA'), ('Bank Transfer', 'Bank Transfer'), ('Other', 'Other')], default='MPESA', max_length=100, null=True, verbose_name='Payment Method')),
                ...
                ('update_history', ckeditor.fields.RichTextField(blank=True, verbose_name='Update History')),
                ('student_ID', models.CharField(blank=True, max_length=10, null=True, verbose_name='Student ID')),
                ('admission_level', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='home.grade', verbose_name='Admission Level * ')),
                ('registration_agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Registration Staff')),
            ],
        ),
    ]
